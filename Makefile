...
.PHONY: help env superglue-finetune train eval infer report report-all figs clean all eval-all-models fewshot-comparison \
...
help:
	...
	@echo "  superglue-llama3.2-1b  - Llama 3.2 1B"
	@echo "  superglue-llama3.2-3b  - Llama 3.2 3B"
	@echo "  superglue-gemma2-2b    - Gemma 2 2B"
	@echo ""
